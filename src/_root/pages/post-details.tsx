...
import { deletePostMutation } from "@/lib/react-query/mutations";
...
const PostDetails = () => {
  ...
  const { mutateAsync: deletePost, isPending: deletePostLoading } =
    deletePostMutation();
  ...
  if (!post) {
    return (
      <p className="mt-20 w-full text-center text-xl font-semibold md:text-2xl">
        Post Not Found!!
      </p>
    );
  }
